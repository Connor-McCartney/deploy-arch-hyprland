...
pacman -S --noconfirm hyprland xdg-desktop-portal-hyprland waybar hyprpaper swww wl-clipboard wofi grim
pacman -S --noconfirm networkmanager wireshark-qt neovim sudo base-devel os-prober grub vlc htop git wget ripgrep fzf bat fd kitty alacritty thunar ydotool
...
useradd -m -G users,wheel,audio,video,input,wireshark -s /bin/bash connor
printf " \n \n" | passwd
printf " \n \n" | passwd connor
